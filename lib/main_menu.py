...
class MainMenuWindow(ttk.Frame, ThemeEngine):
    ...
    def __init__(self, master):
        ...
        master.title("Grossary Management System")
        ...
        # Program Title
        program_title_label = ttk.Label(body_frame, text="GROSSARY MANAGEMENT SYSTEM",
        ...
        inventory_button = tk.Button(body_frame , text="Grossary", image=self.inventory_btn_img,
                                 bd=0, bg=self.button_bg, activebackground=self.button_bg,
